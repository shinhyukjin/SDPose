"""
SDPose-S + Entropy-Weighted KD (CrowdPose, v3 기반)
==================================================

- COCO용 `sdpose_s_v1_entropy_weighted_tuned_v3` 설정을 CrowdPose에 이식
- 관절 수: 14 / 데이터 루트: `/dockerdata/crowdpose`
"""
...
date = '1116'
exp_description = 'crowdpose_entropy_v3'
...
# ============ Model (Entropy-Weighted KD v3, SDPose-S) ============
model = dict(
    type='TopDown',
    ...
    keypoint_head=dict(
        ...
        # Baseline token distillation (살짝 감소)
...
data_cfg = dict(
    ...
    use_gt_bbox=False,
    det_bbox_thr=0.0,
    bbox_file='/dockerdata/crowdpose/crowdpose_annotations/'
