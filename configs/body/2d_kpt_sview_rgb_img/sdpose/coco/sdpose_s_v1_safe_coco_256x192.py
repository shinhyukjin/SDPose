"""
SDPose - Safe High Performance Config
=====================================
발산 문제 완전 해결 - 검증된 방법만 사용

Strategy:
- NO ForegroundTokenDistilLoss (문제 있음)
- Standard TokenDistilLoss only (안정적)
- Slightly increased weight for better performance
...
# ============================================================================
# SAFE Model - Standard TokenDistilLoss Only
# ============================================================================
model = dict(
    type='TopDown',
    ...
    keypoint_head=dict(
        ...
        # ✅ Standard TokenDistilLoss - Proven Stable
        loss_vis_token_dist=dict(
            type='TokenDistilLoss',
            loss_weight=8e-6,  # Slightly increased for performance
        ),
