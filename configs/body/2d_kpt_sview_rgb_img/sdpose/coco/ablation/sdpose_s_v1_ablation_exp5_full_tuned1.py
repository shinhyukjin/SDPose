"""
SDPose-S-V1 Ablation Study: Full (EW losses) - Tuned v1
=======================================================

Tuning goals:
- Re-balance EW losses to avoid overpowering base loss
- Slightly sharpen teacher distribution (lower temperature range)
- Narrow EW weight ranges to reduce instability
"""

_base_ = ['../../../../../_base_/datasets/coco.py']

date = '0102'
exp_description = 'ablation_exp5_full_tuned1'
...
# ============ Model (V1 structure + tuned EW losses) ============
model = dict(
    type='TopDown',
    ...
    keypoint_head=dict(
        ...
        # Entropy-Weighted Heatmap KD (tuned)
        ...
        # Entropy-Weighted Token KD (vis tokens, tuned)
        ...
        # Entropy-Weighted Token KD (keypoint tokens, tuned)
        ...
        # V1 structure: patch_size=[4, 3]
        tokenpose_cfg=dict(
            feature_size=[64, 48],
            patch_size=[4, 3],  # V1 structure: 256 tokens
            dim=192,
            depth=12,
            heads=8,
            mlp_ratio=3,
...
data = dict(
    samples_per_gpu=64,  # V1 structure: 256 tokens, batch size 64
    workers_per_gpu=2,
