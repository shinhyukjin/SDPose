"""
SDPose-S-V2 Ablation Study: Baseline + Token Dist + EW Heatmap + EW Token Vis
===============================================================================
...
Base: v3.6 config (V2 구조만 사용)
"""

_base_ = ['../../../../../_base_/datasets/coco.py']

date = '1224'
exp_description = 'ablation_exp4_ew_heatmap_token_vis'
...
# ============ Model (V2 구조 + Base Loss + Token Dist + EW Heatmap + EW Token Vis) ============
model = dict(
    type='TopDown',
    ...
    keypoint_head=dict(
        ...
        # Entropy-Weighted Token KD (vis tokens only)
...
data = dict(
    samples_per_gpu=32,  # Reduced for V2 structure (768 tokens)
    workers_per_gpu=2,
