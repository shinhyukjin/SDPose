"""
SDPose-S-V2 Ablation Study: Full (v3.6)
=========================================
...
Base: v3.6 config (V2 구조 + 모든 EW losses)
"""

_base_ = ['../../../../../_base_/datasets/coco.py']

date = '1224'
exp_description = 'ablation_exp5_full'
...
# ============ Model (SDPose-S-V2 구조 + v3.5 Entropy-Weighted KD) ============
model = dict(
    type='TopDown',
    ...
    keypoint_head=dict(
        ...
        # 🔥 Entropy-Weighted Heatmap KD (v3.5와 동일)
        ...
        # 🔥 Entropy-Weighted Token KD (vis tokens, v3.5와 동일)
        ...
        # 🔥 Entropy-Weighted Token KD (keypoint tokens, v3.5와 동일)
        ...
        # 🔥 V2 구조: patch_size=[2, 2] (V1은 [4, 3])
        tokenpose_cfg=dict(
            feature_size=[64, 48],
            patch_size=[2, 2],  # V2 구조: 더 많은 토큰 (768 tokens)
            dim=192,
            depth=12,
            heads=8,
            mlp_ratio=3,
