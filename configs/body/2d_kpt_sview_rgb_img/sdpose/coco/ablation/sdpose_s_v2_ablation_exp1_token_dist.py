"""
SDPose-S-V2 Ablation Study: Baseline + Token Distillation
===========================================================
...
date = '1224'
exp_description = 'ablation_exp1_token_dist'
...
# ============ Model (V2 구조 + Base Loss + Token Distillation) ============
model = dict(
    type='TopDown',
...
data = dict(
    samples_per_gpu=16,  # Reduced for V2 structure (768 tokens)
    workers_per_gpu=2,
