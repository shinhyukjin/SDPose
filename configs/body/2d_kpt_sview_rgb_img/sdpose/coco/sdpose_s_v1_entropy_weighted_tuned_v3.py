"""
SDPose + Entropy-Weighted KD (Tuned v3)
======================================

Stacked improvements on top of tuned v2:
- Stronger entropy temperature scaling & wider weight band
- Soft foreground masking + visibility floor for occluded joints
- Split entropy-weighted token KD for vis/kpt tokens with custom ranges
- Late-stage LR decay to stabilise final convergence
"""

_base_ = ['../../../../_base_/datasets/coco.py']

date = '1112'
exp_description = 'entropy_weighted_tuned_v3'
...
model = dict(
    ...
    keypoint_head=dict(
        ...
        # Baseline token distillation (slightly reduced)
        ...
        # 🔥 Entropy-Weighted Heatmap KD (soft mask + wider weight range)
        ...
        # 🔥 Entropy-Weighted Token KD (vis tokens)
        ...
        # 🔥 Entropy-Weighted Token KD (keypoint tokens)
